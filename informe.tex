...
Para esta reduccion, decidimos reducir el problema del Balanceo de Carga (que llamaremos B.C.) al problema de los maestros del agua (que llamaremos M.A.). Esto es decir, nuestra reduccion polinomial va a ser de la forma:
$$
BC \leq_p MA
$$
...
$$
\min \displaystyle{\sum_{i = 1}^{m}} (\displaystyle{\sum_{j \in A(i)} t_j})
$$

A simple vista, vemos que tiene una gran similutd con el planteamiento de nuestro problema, descripto en \nameref{sec:descripcion}.
