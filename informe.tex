...
Para esto, generamos 20 instancias $I$. Cada una de ellas tenia una cantidad ascendente de maestros, habilidades aleatorias y una cantidad $k$ aleatoria (menor que $n$).
