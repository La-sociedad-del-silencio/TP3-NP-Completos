...
La versión de decisión de este problema dice: Dado un numero $m$ de maquinas, una succione $n$ de trabajos, y un numero B, determinar si existe un asignación de trabajos en las $m$ maquinas, tal que el máximo $T_i$ sea menor o igual a $B$.

\subsubsection{Desarrollo}
Basándonos en lo antes expuesto, podemos realizar la siguiente reducción:
