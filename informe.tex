...
Para corroborar la cota encontrada, $r(A) = 1.02$, también realizamos mediciones con mayores volúmenes de datos, con $n$ \in {10, 100, 1000, 10000}. Obtuvimos $r(A) = 1.0256009216095232 \approx 1.0256$.
...
\begin{itemize}
    ...
    \item Aproximación de la cátedra $\rightarrow$ $r(A) = 1.0256009216095232 \approx 1.03$.
...
Esta tiene una complejidad de $\mathcal{O}(n \cdot k)$, sin embargo, en general los valores de $k$ suelen ser más chicos que $n$ (ya que si $n = k$ la solución es trivial). Y además, lo destacable de este algoritmo es que no solo tiene un tiempo de ejecución considerablemente menor, sino que ademas da un resultado que suele ser solamente $1.03$ veces peor que el resultado óptimo.
